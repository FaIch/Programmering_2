...
public class CreateNewArmyController {
     ...
     * Also checks whether the army name is only using allowed characters and is within the max characters limit
     */
    @FXML
    void checkName(){
    ...
    /**
     * Method for enabling/disabling the buttons and fields to add units
    ...
    /**
     * Checks whether the input for army name is using only alphanumeric characters
